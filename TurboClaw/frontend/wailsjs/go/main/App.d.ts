...
export function CheckPathsInWorkspace(arg1:Array<string>):Promise<Array<string>>;

export function CheckPermissions():Promise<Array<main.PermissionStatus>>;
...
export function GetChannelConfig():Promise<Record<string, any>>;
...
export function RequestPathAuthorization(arg1:Array<string>):Promise<boolean>;

export function SaveChannelConfig(arg1:Record<string, any>):Promise<void>;
